...
//since we have 240 interrupts, and 7 registers every register of the 7 holds 32 interrupt(each interrupt has 8 bits out of the size of the register which is 32) & Copy_u8INTID is the number of the interrupt
#define NUMBER_OF_INTERRUPT_PER_REGISTER 32
// since this chip offers only 91 interrupt out of 240, ST limited to option to write to the full 8 bits to 4 bits only classified to 4 options(Copy_u8PriorityOption)to set the group priority and sub priority
#define INTERRUPT_SIZE 8
#define INTERRUPT_SHIFT_VALUE_BIT 256
#define INTERRUPT_RECONFIGURTION_SIZE 4

//WRITING ON LAST 4 BITS OF EACH INTERRUPT
#define INTERRUPT_RECONFIGURTION_WRITE_SHPR1 3
#define INTERRUPT_RECONFIGURTION_WRITE_SHPR2 7
#define INTERRUPT_RECONFIGURTION_WRITE_SHPR3 8
#define INTERRUPT_RECONFIGURTION_WRITE_IPR 0
/******************************************************************************/
